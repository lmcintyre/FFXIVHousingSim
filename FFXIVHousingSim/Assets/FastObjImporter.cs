 ...
 *
 * Class was modified for this project to support MaterialHandler, colors, and Vector4 uvs.
 */
...
public sealed class FastObjImporter
{
    ...
    {
        meshName = filePath.Substring(filePath.LastIndexOf('\\') + 1);
        ...
        Color32[] newColors = new Color32[faceData.Count];
        ...
        for (int i = 0; i < faceData.Count; i++)
        {
            ...
            newColors[i] = colors[faceData[i].x - 1];
